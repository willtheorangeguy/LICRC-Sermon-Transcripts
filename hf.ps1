...
foreach ($Year in $YearFolders) {
    ...
    $RepoId = "$Year-LICRC-Transcripts"
    $PrettyName = "$Year LICRC Sermon Transcripts"
...
Complete transcripts from the $Year sermons of Langley Immanuel Christian Reformed Church.
