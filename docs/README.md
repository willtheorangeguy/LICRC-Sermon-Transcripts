# LICRC Sermon Transcripts — Documentation

This archive holds machine-generated transcripts and summaries for the Langley Immanuel CRC sermons, together with the pipeline that produces them. The pipeline runs as 5 numbered stages; `main.py` executes them in order.
